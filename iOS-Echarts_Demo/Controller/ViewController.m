...
- (void)setRightBar
{
    ...
    [btn addTarget:self action:@selector(showTestListViewController) forControlEvents:UIControlEventTouchUpInside];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithCustomView:btn];
}


- (void)showTestListViewController
{
    [self.navigationController pushViewController:[[TestListViewController alloc]init] animated:YES];
}
